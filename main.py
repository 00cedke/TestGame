...
def show_menu():
    while True:
        ...
        start_text = font.render("Press ENTER for play.", True, (0, 0, 0))
        quit_text = font.render("Press ESC for exit.", True, (0, 0, 0))
...
def main_game():
    global player_x, player_y, player_jump, player_jump_speed  # Déclarez les variables globales ici
    player_jump = False
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
